...
def test_metal_tensor_creation():
    ...
    t = Tensor([1.0, 2.0, 3.0], device="metal")
...
def test_metal_matmul():
    ...
    a = Tensor(a_data, device="metal")
    b = Tensor(b_data, device="metal")
...
def test_metal_matmul_mismatch():
    ...
    a = Tensor(np.zeros((10, 20)), device="metal")
    b = Tensor(np.zeros((30, 40)), device="metal")
